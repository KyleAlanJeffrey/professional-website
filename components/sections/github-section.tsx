      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-start mb-8">
        <div className="lg:col-span-5 text-left">
          <div className="flex items-center gap-3 mb-2 md:mb-3">
            <div className="text-xs text-emerald-600 dark:text-emerald-400 tracking-[0.3em] font-bold" style={{ fontFamily: "monospace" }}>DEVELOPMENT</div>
            <div className="w-12 h-0.5 bg-emerald-500 dark:bg-emerald-400"></div>
          </div>
          <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1 mb-2 md:mb-3">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black bg-gradient-to-r from-emerald-500 to-gray-900 dark:from-emerald-400 dark:to-white bg-clip-text text-transparent transition-all duration-300 tracking-[0.1em]" style={{ fontFamily: "monospace" }}>GITHUB ACTIVITY</h2>
            ...
            <span className="text-4xl md:text-5xl font-black text-emerald-500 dark:text-emerald-400 tracking-[0.1em]" style={{ fontFamily: "monospace" }}>05</span>
          </div>
          <div className="w-12 h-0.5 bg-emerald-500 dark:bg-emerald-400 mb-4"></div>
