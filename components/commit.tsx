...
function Commit(props: { commit: CommitType; index: number }) {
  ...
  return (
    <a
      ...
      className="w-full min-w-0 flex items-center gap-2 sm:gap-4 group cursor-pointer p-2 sm:p-4 rounded-xl sm:rounded-2xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 md:backdrop-blur shadow-[0_12px_24px_rgba(0,0,0,0.12)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(0,0,0,0.16)] hover:border-black/20 dark:hover:border-white/20"
    >
      <div
