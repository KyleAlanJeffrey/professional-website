...
function InvestigationCard({
  ...
  return (
    <div className="rounded-2xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/[0.03] p-6 md:p-8 mb-8">
      <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 mb-4">
        <span className="text-xs font-mono font-bold tracking-[0.15em] text-indigo-500 dark:text-indigo-400 uppercase">
          Investigation {number}
        </span>
        <span className={`text-xs font-mono font-bold tracking-[0.1em] uppercase ${verdictColor}`}>
          {verdict}
        </span>
        <span className="text-xs font-mono font-bold tracking-[0.1em] text-gray-400 dark:text-gray-500 ml-auto">
          {score}
        </span>
      </div>
      <h4 className="text-xl font-black font-mono tracking-tight text-gray-900 dark:text-white mb-4">
        {title}
      </h4>
      {children}
    </div>
  ...
  return (
    <FadeIn>
      <section id="ch3" className="mb-16 scroll-mt-20">
        ...
        {/* ─── Investigation 1: Geared Bar ─── */}
        <div id="ch3-geared-bar" className="scroll-mt-20">
          <InvestigationCard
            number="01"
            title="Geared Bar Mechanism (Long et al.)"
            verdict="Rejected — poor trajectory"
          ...
          >
            ...
            <div className="rounded-xl border border-black/10 dark:border-white/10 bg-white/50 dark:bg-white/[0.02] overflow-hidden mb-6">
        ...
        {/* ─── Investigation 2: Custom Sliding Cam ─── */}
        <div id="ch3-cam" className="scroll-mt-20">
          <InvestigationCard
            number="02"
            title="Custom Sliding Cam (Original Design)"
            verdict="Rejected — excessive friction"
            verdictColor="text-amber-500 dark:text-amber-400"
            score="6 / 10"
          >
            <div className="prose-custom mb-4">
              <p>
        ...
        {/* ─── Investigation 3: Wan & Song (Winner) ─── */}
        <InvestigationCard
          number="03"
          title="Fixed Bearing Cam (Wan & Song)"
          verdict="Selected — best overall"
          verdictColor="text-emerald-500 dark:text-emerald-400"
          score="9 / 10"
        >
          <div className="prose-custom mb-4">
            <p>
          ...
          <h4 className="text-lg font-bold font-mono tracking-tight text-gray-900 dark:text-white mb-3 mt-8">
        ...
        {/* 3.2 Conclusion */}
        <div id="ch3-conclusion" className="scroll-mt-20" />
